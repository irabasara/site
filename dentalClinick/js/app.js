(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".before-after__slider")) new swiper_core_Swiper(".before-after__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (window.innerWidth > 479.98 && document.querySelector(".team__slider")) new swiper_core_Swiper(".team__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: "auto",
    ...
    videoContainers.forEach((function(container) {
        const playButton = container.querySelector(".play__button");
